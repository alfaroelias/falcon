...
namespace practice_falconsoft
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContextPool<AppDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("connSQL")));
            ...
            var key = System.Text.Encoding.ASCII.GetBytes(appSettings.KeySecret);
